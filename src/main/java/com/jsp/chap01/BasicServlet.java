...
// 역할: HTTP 통신의 요청과 응답 데이터를 손쉽게 처리할 수
// 있게 도와주는 클래스

// WAS (톰캣) 에게 이 서블릿을 언제 호출할지 URL 을 매핑

@WebServlet(urlPatterns = "/login") // urlPatterns 은 생략 할 수 있다.
public class BasicServlet extends HttpServlet {
    // new BasicServlet();이 자동으로 생성된다.
    public BasicServlet() {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 응답 바디에 넣을 html 생성
        PrintWriter w = resp.getWriter(); // 펜 가져오기
